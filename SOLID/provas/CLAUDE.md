# SOLID/provas — Provas de fim de módulo

Uma **prova por módulo**, aplicada ao final para avaliar se o aluno domina o princípio antes de avançar.
...
```bash
python3 engine/session.py start SOLID/provas/modulo-01/questions.json --id prova
...
## Modo solo (opcional)
```bash
python3 SOLID/provas/modulo-01/prova.py
```
...
- Cenários realistas de design em **C#**: "dado este código, qual refatoração respeita o princípio?".
